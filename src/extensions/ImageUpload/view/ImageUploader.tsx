...
const supabase = createClient(
  "https://https://bpfqdbkbnkjiiukrjnic.supabase.co",
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJwZnFkYmtibmtqaWl1a3JqbmljIiwicm9sZSI6ImFub24" +
  "iLCJpYXQiOjE3MTE1NDQ3NjksImV4cCI6MjAyNzEyMDc2OX0.QGEpb-83pyQPujjViSZMkswWCKTKKKWdnbLKI9zLa30"
);
